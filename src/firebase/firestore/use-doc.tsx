 ...
 * Handles nullable references and waits for auth state to be resolved.
 * 
...
export function useDoc<T = any>(
  ...
  useEffect(() => {
    // Wait for auth to finish loading AND for a doc ref to be provided.
    ...
    return () => unsubscribe();
  }, [memoizedDocRef, isUserLoading]); // Re-run when docRef changes or when auth loading is complete.
