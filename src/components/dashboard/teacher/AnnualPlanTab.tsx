...
function PhysicsAnnualPlan({ teacherProfile, currentClass }: { teacherProfile: TeacherProfile | null, currentClass: Class | null }) {
  ...
  const filteredWeeks = useMemo(() => {
    const currentData = gradeConfig[activeGrade as 9 | 10].data;
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 p-4 md:p-8 font-sans">
      <div className="max-w-full mx-auto">
        <header className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-extrabold text-indigo-950 mb-2 tracking-tight">Fizik Dersi Yıllık Planı</h1>
        ...
        <div className="bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-slate-200 mb-8 sticky top-4 z-10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap justify-center md:justify-start gap-2">
              {gradeConfig[activeGrade as 9|10].filters.map((filter) => (
  ...
  return (
    <Tabs defaultValue="physics">
        <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="physics"><BookOpen className="mr-2 h-4 w-4" />Fizik Dersi Yıllık Planı</TabsTrigger>
        ...
        <TabsContent value="physics" className="mt-4">
            <PhysicsAnnualPlan teacherProfile={teacherProfile} currentClass={currentClass} />
        </TabsContent>
