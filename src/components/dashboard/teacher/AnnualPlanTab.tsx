...
import { TeacherProfile, Class, AnnualPlan as AnnualPlanType, DailyPlan as DailyPlanType, AnnualPlanEntry } from '@/lib/types';
  ...
  return (
    <Tabs defaultValue="ders-plani">
      ...
      <TabsContent value="rehberlik-plani" className="mt-4">
        <ClassGuidanceAssistant teacherProfile={teacherProfile} currentClass={currentClass}/>
      </TabsContent>
    </Tabs>
  );
}
