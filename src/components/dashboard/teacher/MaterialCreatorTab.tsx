...
import { BookOpen, Cpu, Save, RefreshCw, Printer, Brain, CheckCircle, GraduationCap, FileText, List, AlertCircle, Library, Sparkles } from 'lucide-react';
...
const MaterialCreatorTab = () => {
  ...
  const createFlexibleTask = (lesson: string, gradeName: string, topicData: any, type: string) => {
