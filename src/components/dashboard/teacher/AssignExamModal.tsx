        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh]">
          ...
          <div className="p-6 overflow-y-auto space-y-5">
             <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 text-sm text-blue-800 mb-2">
              <span className="font-bold">{exam.examInfo.title}</span> sınavını ödev olarak atıyorsunuz.
            </div>
            ...
            <div className="min-h-[200px]">
                ...
                {selectedClassIds.length > 0 ? (
                    (classes || []).filter((c:any) => selectedClassIds.includes(c.id)).map((cls:any) => {
