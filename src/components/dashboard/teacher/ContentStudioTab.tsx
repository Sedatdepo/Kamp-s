...
import { 
  BookOpen, Cpu, Save, RefreshCw, Printer, Brain, CheckCircle, GraduationCap, FileText, List, AlertCircle, Library, Sparkles, Wand2, PlusCircle, Trash2, FileDown, Loader2, Search, Plus, X, Check, ChevronsUpDown, AlignLeft, CheckSquare, Binary, Shuffle, ImageIcon, Send, Paperclip
} from 'lucide-react';
